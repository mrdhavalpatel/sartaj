  ...
  return (
      <>
                          ...
                          {redeem && elebal > 0 ? (
                              <tr>
                                <td
                                    ...
                                    className="text-start"
                                >
                                  <strong>{intl.formatMessage({ id: "Wallet" })}</strong>
                                </td>
                                <td
                                    style={{
                                      border: "1px solid #bababa",
                          ...
                          {coupanRes ? (
                              <tr>
                                <td
                                    ...
                                    className="text-start"
                                >
                                  <strong>{intl.formatMessage({ id: "Discount price" })}</strong>
                                </td>
                                <td
                                    style={{
                                      border: "1px solid #bababa",
                                    ...
                                    className="text-end"
                                >
                                  <span className="fw-600">¥{coupanRes?.discount_price}</span>
                                </td>
                              </tr>
                          ) : null}
                          <tr>
        ...
        <span className="font-lg fw-900 text-brand">
          ...
          {redeem
              ? (coupanRes
                  ? coupanRes.orderAmount - elebal
                  : cartTotal?.total_amt - elebal)
              : (coupanRes
                  ? coupanRes.orderAmount
                  : cartTotal?.total_amt)}
        </span>
