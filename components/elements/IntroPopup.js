                        ...
                        <div className="modal-body">
                            ...
                            >
                                <div className="deal-top">
                                    <h2 className="text-brand">Deal of the Month</h2>
                                    <h5>Limited Offer.</h5>
                                </div>
                                <div className="deal-content  detail-info">
                                    ...
                                    <div className="clearfix product-price-cover">
                                        <div className="product-price primary-color float-left">
                                            <span className="current-price text-brand">¥120</span>
                                            <span>
                                                <span className="save-price font-md color3 ml-15">48% Off</span>
                                                <span className="old-price font-md ml-15">¥250</span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
