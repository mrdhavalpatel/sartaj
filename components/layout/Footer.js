                                ...
                                >
                                    ...
                                    <ul className="contact-infor">
                                        ...
                                        <li>
                                            ...
                                            <strong>Hours:</strong>
                                            <span>
                                                Monday to Saturday from 09:00AM-18:00PM (except national holiday)
                                            </span>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-6 text-end d-none d-md-block">
                            <div className="mobile-social-icon">
                                ...
                                <a href="https://www.instagram.com/sartaj_foods_official/" target="_blank">
                                    <img
                                        src="/assets/imgs/theme/icons/icon-instagram-white.svg"
                                        alt="nest"
                                    />
                                </a>
                                <a href="https://www.linkedin.com/company/sartaj-foods-japan/" target="_blank">
                                    <img
